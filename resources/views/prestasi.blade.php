<x-layout title="Prestasi - SMK PGRI 3 Malang">
    <div class="h-full container mx-auto px-4 py-6">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 sm:p-8" id="prestasi-container">
            <div class="bg-gray-100 rounded-xl shadow-lg px-4 sm:px-6 py-3 sm:py-4 grid grid-cols-3 items-center mb-6">
                ...
                <div class="flex items-center justify-center">
                    <h2 class="text-4xl sm:text-5xl font-bold text-center" style="text-shadow: 2px 2px 5px #FFD700;">
                        PARA JAWARA
                    </h2>
                </div>
                <img src="{{ $assetBase . '/assets/troph-pres.png' }}"
                    class="w-20 h-20 sm:w-28 sm:h-28 drop-shadow-md transform scale-125 -rotate-12 ml-3" alt="Gambar"
                    loading="lazy">
                <div></div>
                <div></div>
            </div>
            ...
            <div id="loading" class="hidden justify-center items-center py-8">
                ...
                <span class="ml-3 text-gray-600 font-medium">Memuat prestasi...</span>
            </div>
