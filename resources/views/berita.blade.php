            ...
            <div class="flex flex-wrap justify-between items-center mb-8 bg-white p-4 rounded-lg shadow">
                ...
                <div class="flex flex-wrap justify-between items-center mb-8 bg-white p-4 rounded-lg shadow">
                    ...
                    <div class="flex flex-wrap gap-2" id="filterButtons">
                        <button class="filter-btn {{ $type === 'all' ? 'bg-customBlue text-white' : 'hover:bg-gray-300 text-gray-700' }} px-4 py-2 rounded-lg text-sm font-medium transition-colors" data-type="all">Semua</button>
                        <button class="filter-btn {{ $type === 'prestasi' ? 'bg-customBlue text-white' : 'hover:bg-gray-300 text-gray-700' }} px-4 py-2 rounded-lg text-sm font-medium transition-colors" data-type="prestasi">Prestasi</button>
                        <button class="filter-btn {{ $type === 'kegiatan' ? 'bg-customBlue text-white' : 'hover:bg-gray-300 text-gray-700' }} px-4 py-2 rounded-lg text-sm font-medium transition-colors" data-type="kegiatan">Kegiatan</button>
                        <button class="filter-btn {{ $type === 'pengumuman' ? 'bg-customBlue text-white' : 'hover:bg-gray-300 text-gray-700' }} px-4 py-2 rounded-lg text-sm font-medium transition-colors" data-type="pengumuman">Pengumuman</button>
                        <button class="filter-btn {{ $type === 'acara' ? 'bg-customBlue text-white' : 'hover:bg-gray-300 text-gray-700' }} px-4 py-2 rounded-lg text-sm font-medium transition-colors" data-type="acara">Acara</button>
                    </div>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        filterButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                filterButtons.forEach(btn => btn.classList.remove('bg-customBlue', 'text-white'));
