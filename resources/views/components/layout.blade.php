...
<body class="bg-[#F8F8F8] m-0 p-0 overflow-x-hidden" x-data="{ modalOpen: false, modalTitle: '', modalDept: '', modalDesc: '', modalImage: '' }" x-on:open-modal.window="modalOpen = true; modalTitle = $event.detail.title; modalDept = $event.detail.dept; modalDesc = $event.detail.desc; modalImage = $event.detail.image">
    <x-b2t></x-b2t>
